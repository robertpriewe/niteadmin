            <div class="row">
                <div class="col-12">
                    ...
                    <div class="card-body">
                        <?php
                        $query = mysqli_query($mysqli, "SELECT * FROM events_sponsors_link LEFT JOIN sponsors ON events_sponsors_link.SPONSORID = sponsors.SPONSORID RIGHT JOIN events ON events_sponsors_link.EVENTID = events.EVENTID WHERE events_sponsors_link.EVENTID = " . $_GET['eventid']);
                        ...
                        <div class="row">
                            <div class="col-lg-12 row">
                                <div class="col-lg-9">
                                    <h5 class="mb-3 text-uppercase bg-light p-2"><i class="mdi mdi-account-circle mr-1"></i> Sponsor list for: <?php echo $eventname; ?></h5>
                                </div>
                                <div class="col-lg-3">
                                    <div class="text-lg-right mt-3 mt-lg-0">
                                        <a href="#custom-modal" class="btn btn-danger waves-effect waves-light" data-animation="fadein" data-toggle="modal" data-overlayColor="#38414a" onclick="javascript:openModal('Assign Sponsor','ajax/ajaxmodalsponsorlist.php?eventid=<?php echo $_GET['eventid']; ?>');"><i class="mdi mdi-plus-circle mr-1"></i> Assign New Sponsor</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-md-6 col-xl-3">
                                    <div class="card-box">
                                        ...
                                        <h3><?php echo '99'; ?></h3>
                                        <p class="text-uppercase mb-1 font-13 font-weight-medium">Total Sponsors</p>
                                    </div>
                                </div>
                                <div class="col-md-6 col-xl-3">
                                    <div class="card-box">
                        ...
                        <table class="table table-hover m-0 table-centered dt-responsive nowrap w-100" cellspacing="0" id="tickets-table">
                            ...
                            if (count($queryarray) > 0) {
                                foreach ($queryarray as $rowquery) {
                                    ...
                                    echo '                            <tr>
                                <td><a href="?page=eventsponsordetails&eventsponsorid=' . $rowquery['EVENTSPONSORID'] . '"><b>' . $rowquery['EVENTSPONSORID'] . '</b></a></td>
                                <td>
                                    <a href="javascript: void(0);" class="text-dark">
                                        <span class="ml-2">' . $rowquery['SPONSORNAME'] . '</span>
                                    </a>
                                </td>

                                <td>' . $rowquery['SPONSORTYPE'] . '</td>
                                
                                <td>' . $rowquery['SPONSORPHONE'] . '</td>
