...
<!-- ============================================================== -->
<?php
$query = mysqli_query($mysqli, 'SELECT * FROM sponsors ORDER BY SPONSORNAME ASC');
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-lg-12 row">
                                <div class="col-lg-10">
                                    <h5 class="mb-3 text-uppercase bg-light p-2"><i class="mdi mdi-account-circle mr-1"></i> Sponsors</h5>
                                </div>
                                <div class="col-lg-2">
                                    <div class="text-lg-right mt-3 mt-lg-0">
                                        <a href="#custom-modal" class="btn btn-danger waves-effect waves-light" data-animation="fadein" data-toggle="modal" data-overlayColor="#38414a" onclick="javascript:openModal('Add New Sponsor','ajax/ajaxmodaladdnewsponsor.php');"><i class="mdi mdi-plus-circle mr-1"></i> New Sponsor</a>
                                    </div>
                                </div>
                            </div>
                        </div>
