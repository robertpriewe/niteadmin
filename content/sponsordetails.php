...
if (!isset($_GET['sponsorid'])) {
    echo '<div class="content-page">No sponsor ID found</div>';
} else {
    $query = mysqli_query($mysqli, 'SELECT * FROM sponsors WHERE sponsors.SPONSORID = ' . $_GET['sponsorid'] . ' LIMIT 0, 1');
    while($row = $query->fetch_array()) {
        $rowvendors = $row;
    }
    $query = mysqli_query($mysqli, 'SELECT * FROM contacts_link JOIN contacts ON contacts_link.CONTACTID = contacts.CONTACTID WHERE LINKTABLE = "sponsors" AND LINKID = "' . $_GET['sponsorid'] . '" ORDER BY ORDERID ASC');
    $rowcontacts = array();
    while($row = $query->fetch_array()) {
        $rowcontacts[] = $row;
    }
            ...
            <div class="row">
                <div class="col-lg-6 col-xl-6">
                    ...
                    <div class="card-body text-center">
                        ...
                        <h4 class="mb-0"><?php echo $rowvendors['SPONSORNAME']; ?></h4>
                        <p class="text-muted">Sponsor Type: <?php echo $rowvendors['SPONSORTYPE']; ?></p>
                        ...
                        <div class="text-left mt-3">
                            <div class="row">
                                <div class="col-sm-6"><h4 class="font-13 text-uppercase">Sponsor Info</h4></div>
                            ...
                            <table class="table table-centered table-borderless table-striped mb-0">
                                ...
                                <?php
                                echo '<tr>
                                        <td style="width: 35%;">SPONSORNAME</td>
                                        <td><a class="changefield" href="#" data-type="text" data-pk="{id:' . $_GET['sponsorid'] . ',page:\'sponsors\'}" data-name="SPONSORNAME">' . $rowvendors['SPONSORNAME'] . '</a></td>
                                    </tr>';
                                echo '<tr>
                                        <td style="width: 35%;">SPONSORTYPE</td>
                                        <td><a class="changefield" href="#" data-type="text" data-pk="{id:' . $_GET['sponsorid'] . ',page:\'sponsors\'}" data-name="SPONSORTYPE">' . $rowvendors['SPONSORTYPE'] . '</a></td>
                                    </tr>';
                                echo '<tr>
                                        <td style="width: 35%;">SPONSORPHONE</td>
                                        <td><a class="changefield" href="#" data-type="text" data-pk="{id:' . $_GET['sponsorid'] . ',page:\'sponsors\'}" data-name="SPONSORPHONE">' . $rowvendors['SPONSORPHONE'] . '</a></td>
                                    </tr>';
                                ?>
                                </tbody>
                            </table>
                    ...
                    <div class="card">
                    <div class="card-body">
                        <h4 class="header-title">Sponsor Notes</h4>
                        <?php echo '<p class="mb-3"><a class="changefield" href="#" data-type="textarea" data-pk="{id:' . $_GET['sponsorid'] . ',page:\'sponsors\'}" data-name="SPONSORNOTES">' . $rowvendors['SPONSORNOTES'] . '</a></p>'; ?>
                    </div>
                    </div> <!-- end card-box-->
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane show active" id="teaminfo">
                                ...
                                if (count($rowcontacts) > 0) {
                                    ...
                                    <a href="#custom-modal" class="btn btn-danger btn-xs waves-effect mb-2 waves-light" data-animation="fadein" data-toggle="modal" data-overlayColor="#38414a" onclick="javascript:openModal(\'Are you sure you want to unassign this contact?\',\'ajax/ajaxmodalconfirmdeletion.php?action=unassigncontact&sponsorid=' . $_GET['sponsorid'] . '&contactid=' . $contactrow['CONTACTID'] . '\');"><i class="mdi mdi-delete mr-1"></i> Remove</a>
                                    </div></div></div>
                                    <div class="card-body">
