...
function b2blogic($B2BID, $SETID, $ARTISTNAME, $OUTPUT) {
    ...
    if ($B2BID == NULL) {
        return '<button type="button" class="btn btn-sm btn-primary waves-effect waves-light mr-1" href="#custom-modal" data-animation="fadein" data-plugin="custommodal" data-overlayColor="#38414a" onclick="javascript:openModal(\'Create B2B Set\',\'ajax/ajaxmodalsetlist.php?setid=' . $SETID . '\');"><i class="mdi mdi-magnet"></i> Create B2B</button>';
    } else {
